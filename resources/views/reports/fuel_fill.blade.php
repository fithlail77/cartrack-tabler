            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <h5 class="m-b-10">Report Vehicle Fuel Fill</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped" id="fuel-fill-table">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Registrasi</th>
...
$(function() {
    var table = $('#fuel-fill-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('reports.fuel-fill.data') }}",
        ...
        columns: [
            ...
            {data: 'fill_ammount_litres', name: 'fill_ammount_litres'},
            {data: 'fill_odometer', name: 'fill_odometer'},
            {data: 'fill_timestamp', name: 'fill_timestamp'},
            {data: 'fill_location', name: 'fill_location'},
            {data: 'latitude', name: 'latitude'},
            {data: 'longitude', name: 'longitude'},
            {data: 'accurate', name: 'accurate'},
        ]
    });
    ...
    $('#exportBtn').click(function() {
        ...
        var url = "{{ route('reports.fuel-fill.export') }}?" + 
