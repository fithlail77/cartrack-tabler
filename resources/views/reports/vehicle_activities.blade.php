            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <h5 class="m-b-10">Report Vehicle Activities</h5>
                        </div>
                    </div>
                </div>
            </div>
...
$(function() {
    var table = $('#activity-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('reports.activity.data') }}",
        ...
        columns: [
            ...
            {
                data: 'driving_time_seconds', 
                render: function(data) {
                    return formatSeconds(data);
                }
            },
            {data: 'total_working_hours', name: 'total_working_hours', orderable: false, searchable: false},
    ...
    $('#exportBtn').click(function() {
        ...
        var url = "{{ route('reports.activity.export') }}?" + 
